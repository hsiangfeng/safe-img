...
<script type="module">
  ...
  // 或：'https://cdn.jsdelivr.net/npm/safe-img@0.1.2/+esm'
...
<!-- 或 jsDelivr：https://cdn.jsdelivr.net/npm/safe-img@0.1.2/dist/index.global.js -->
<script>
...
> 正式環境建議**鎖版本**（`@0.1.2`）。不寫版本（直接 `safe-img`）會解析成 `latest`，CDN 端最久會快取 12 小時 —— prototype 沒差，正式用很危險。
